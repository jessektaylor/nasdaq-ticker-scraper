...
class NasdaqSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.eoddata.com/stocklist/NASDAQ/{}.htm'.format(letter) for letter in letters]
    ...
    def parse(self, response):
        ...
        for row in rows:
            ticker = row.xpath('.//td/a[starts-with(@title,"Display Quote & Chart for NASDAQ")]/text()').get()
